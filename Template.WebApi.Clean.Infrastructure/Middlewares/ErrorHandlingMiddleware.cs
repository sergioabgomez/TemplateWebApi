...
namespace Template.WebApi.Clean.Infrastructure.Middlewares
{
	public class ErrorHandlingMiddleware
	{
		...
		public ErrorHandlingMiddleware(RequestDelegate nextDelegate, ILogger<ErrorHandlingMiddleware> loggerFactory)
		{
			next = nextDelegate;
		...
		private async Task HandleExceptionAsync(HttpContext context, Exception exception)
		{
			...
			logger.Log(logLevel, exception, "{Title}: {Message}", problemDetails.Title, problemDetails.Detail);
